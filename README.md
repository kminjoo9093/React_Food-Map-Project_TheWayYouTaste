...
- **[현재 위치 기반 좌표](./src/hooks/useGeolocation.js) → [행정구역 변환 및 지역 세팅](./src/hooks/useInitLocationInfo.js) → [지역 기반 맛집 데이터 로딩](./src/pages/search/SearchStore.js#L95-L105)** 흐름 설계로 
