    ...
    <div className="contentTopPosition container">
      <section className={styleRanking.rankingHeader}>
        <h2 className={styleRanking.title}>
          <FontAwesomeIcon
            icon={faTrophy}
            style={{ color: "#ffca28", marginRight: "1rem" }}
          />
          지역별 맛집 랭킹
        </h2>
        ...
        <div className={styleRanking.filterBar}>
          ...
          >
            ...
            <span className={styleMain.filterText}>{regionName}</span>
        ...
        <ul className={styleRanking.list}>
          {nowMembers.map((store, index) => (
            <li key={store.bplcSn} className={styleRanking.rankItem}>
              <div className={styleRanking.rankBadge}>
                {index + 1 + firstMember}
              </div>

              <Link
                to={`/store/storeDetail?storeId=${store.bplcSn}`}
                className={styleRanking.itemLink}
              >
                ...
                <div className={styleRanking.infoBox}>
                  <div className={styleRanking.infoTop}>
                    ...
                    <span className={styleRanking.category}>
                      {store.storeCatName}
                    </span>
                  </div>
