    ...
    <div className={styleGlobal.container}>
      <div className={styleStore.storeContainer}>
        <form onSubmit={handleSubmit}>
          ...
          {/* 편의시설 */}
          <p>편의사항</p>
          <label className={`${styleStore.checkbox} ${pet ? styleStore.active : ""}`}>
            🐕<br />반려견
            <input
              type="checkbox"
              checked={pet}
          ...
          <label className={`${styleStore.checkbox} ${parking ? styleStore.active : ""}`}>
            🅿️<br />주차
            <input
              type="checkbox"
              checked={parking}
          ...
          <label className={`${styleStore.checkbox} ${takeout ? styleStore.active : ""}`}>
            🥡<br />포장
            <input
              type="checkbox"
              checked={takeout}
